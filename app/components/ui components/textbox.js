...
export default function TextBox({...props}){
    ...
    return(
        ...
        <input onChange={(e) => onChange(e.target.value) ?? e} className={`${props.inputStyle} transition-all outline-white-900/30 outline outline-1 focus:outline-turquoise-50 p-2 h-10 w-full`} 
